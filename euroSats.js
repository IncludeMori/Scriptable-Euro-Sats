/*
Displays the current 1 Euro -> Satoshi exchange rate
*/
...
function satoshiPrice() {
    const priceSats = apiReq[0].current_price / 100000000
    const price = Math.floor(1/priceSats)
...
function createWidget() {
    ...
    let descr = widgetL.addText("EUR - Sats")
    descr.font = Font.boldSystemFont(14)
